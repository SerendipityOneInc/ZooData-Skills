...
- `analysis-constitution.md` owns the repository-wide rule hierarchy, universal analysis principles and Gates, and user-facing implementation boundary. Every keyword module may add or narrow domain rules but must not duplicate, weaken, or override it.
