...
- HTTP 5xx after the client's built-in retries means the service is currently unavailable for that request. It does not establish that the requested date or other parameters are invalid.
