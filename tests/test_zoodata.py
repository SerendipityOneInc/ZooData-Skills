...
class TestEndpointRouting(unittest.TestCase):
    ...
    def test_market_filters_use_new_names(self):
        r = run_cli("market", "--category-name", "Health & Household",
                    ...
                    "--revenue-min", "100000", "--top100-fbm-rate-max", "0.5",
                    "--sort", "totalMonthlyRevenue")
...
class TestCategoryResolutionMeta(unittest.TestCase):
    ...
    def test_keyword_extends_rejects_unsupported_date(self):
        with self.assertRaises(SystemExit):
            run_cli("keyword-extends", "--query", "yoga mat", "--date", "2026-06-29")
