...
| 🔎 [`amazon-keyword-traffic-analysis/`](amazon-keyword-traffic-analysis/) | ABA-backed keyword intelligence — expansion, bid-worthiness verdicts, reverse ASIN, traffic diagnosis (8 endpoints) | Seed keyword, target keyword, ASIN, or ASIN + keyword | Priority/Selective/Observe/Exclude test tiers, single-keyword verdicts, reverse-ASIN traffic terms, anomaly explanations | Amazon Brand Analytics (ABA) data — real search demand, not scraped estimates |
