...
- `sampleConservativeNewProductCount6m`, `sampleConservativeNewProductRate6m`, and related monthly sales/revenue fields use the service's conservative new-product classification in the selected Top 100. They are not an exhaustive count of category entrants or a survival rate.
